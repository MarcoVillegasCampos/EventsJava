...
import com.codingdojo.events.services.ProjectService;
...
public class ProjectController {
	...
	public String registerProcess(@Valid @ModelAttribute("userReg")User uReg,BindingResult result,RedirectAttributes rA) {
		...
		if(result.hasErrors()) {
			rA.addFlashAttribute("error","<p class=\"alert alert-danger\" role=\"alert\"> Registration failed check your info! </p>");
			return"redirect:/";
		}
		else {
